...
* **Binary install**: Get a release [here](https://github.com/max-hontar/go-jsonschema/releases).

* **From source**: Go 1.11 or later, with Go modules enabled, is advisable in order to get the right dependencies. To install:

```shell
$ go get github.com/max-hontar/go-jsonschema/...
$ go install github.com/max-hontar/go-jsonschema/cmd/gojsonschema
```
